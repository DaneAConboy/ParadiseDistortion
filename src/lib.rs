...
struct ParadiseDisortion {
	threshold: f32 
}

impl Default for ParadiseDisortion {
    fn default() -> ParadiseDisortion {
        ParadiseDisortion {
            threshold: 1.0
        }
    }
...
impl Plugin for ParadiseDisortion {
    fn get_info(&self) -> Info {
        Info {
            name: "ParadiseDisortion".to_string(),
            vendor: "P3Paradise".to_string(),
            unique_id: 454693961,
